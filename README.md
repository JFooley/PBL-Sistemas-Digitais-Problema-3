...
Nosso jogo toma inspiração desse clássico mas com uma nova premissa e objetivos. O jogador ainda controla uma nave espacial, mas desta vez seu objetivo é destruir os meteoros que ameaçam a Terra. A jogabilidade mantém a essência do original, exigindo reflexos rápidos e precisão nos tiros, mas a nova temática adiciona traz mais originalidade e criatividade em relação conceito clássico. O jogador deve proteger a Terra destruindo todos os meteoros antes que eles atinjam a superfície, aumentando a tensão e a urgência em cada partida.
